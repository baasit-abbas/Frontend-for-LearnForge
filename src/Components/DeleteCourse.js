  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (props.getter.courses) {
        ...
        new_courses.courses = new_courses.courses.filter(
    ...
    <Dialog open={open} onOpenChange={setopen}>
      ...
      >
        ...
        <button
          ...
          className="bg-red-600 hover:bg-red-500 transition-all duration-300 w-full py-2 text-lg select-none rounded-full cursor-pointer flex items-center justify-center text-white"
        >
