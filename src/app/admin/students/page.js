  ...
  return (
    <div className="flex flex-col gap-3 px-15">
      <AdminPageHeader search={settext} heading="Students" />
        {handleSearch().length == 0 && <div className="w-full h-full flex items-center justify-center"><h1 className="text-5xl font-bold">No Students Found</h1></div>}
        ...
        {handleSearch().map((std) => {
          return (
            <StudentCard
              ...
              email={std.email}
              last_login={std.last_login? std.last_login.split('T')[0] : 'Not logged in yet'}
